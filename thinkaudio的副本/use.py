...
def get_token():
    ...
    _params = urllib.urlencode({'grant_type': 'client_credentials',
                                'client_id': '9672208',#改成你自己的
                                'client_secret': 'Q4RCVGVDrrvZXcFN9tx1kOjR2O0c8DsY'})#改成你自己的
...
def wav_to_text(wav_file):
    ...
    n_frames = wav_file.getnframes()#frame是长度
    frame_rate = wav_file.getframerate()#rate频率
